...
int main()
{
    ...
    for (int platformIndex = 0; platformIndex < platformsCount; ++platformIndex) {
        ...
        for (int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex) {
			...
			std::cout << "        Device memory: " << memSize / (1024 * 1024) << std::endl;
			...
			std::cout << "        Max clock frequency: " << maxClockFrequency << std::endl;
			...
			if (deviceAvailable == CL_TRUE)
				std::cout << "        Device available: True" << std::endl;
			else
				std::cout << "        Device available: False" << std::endl;
